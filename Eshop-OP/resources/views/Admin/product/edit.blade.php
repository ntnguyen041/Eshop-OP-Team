                ...
                <form action="{{route('admin.product.update', $product->id)}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-6">
                        <label for="large-input"
                            ...
                            Product</label>
                        <input type="text" name="Name" value="{{$product->Name}}" id="large-input"
                    ...
                    <div class="mb-6">
                        ...
                        <input type="text" name="Description" value="{{$product->Description}}" id="small-input"
                    ...
                    <div class="mb-6">
                        ...
                        <input type="number" name="Price" value="{{$product->Price}}" id="small-input"
                            class="block p-4 w-full text-gray-900 bg-gray-50 rounded-lg border border-gray-300 sm:text-xs focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        @error('Price')
                        <span class="text-red-500">{{$message}}</span>
                        @enderror
                    ...
                    <div class="mb-6">
                        ...
                        <input type="number" name="Stock" value="{{$product->Stock}}" id="small-input"
                            class="block p-4 w-full text-gray-900 bg-gray-50 rounded-lg border border-gray-300 sm:text-xs focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        @error('Stock')
                        <span class="text-red-500">{{$message}}</span>
                        @enderror
