...
<div class="flex-none w-full max-w-full px-8">
    <div class="flex flex-wrap -mx-3">
        <div class="flex-none w-full max-w-full px-3">
                ...
                <table class="items-center w-full mb-0 align-top border-collapse dark:border-white/40 text-slate-500">
                    ...
                    <tbody>
                        <td
                            ...
                            <img src="/images/product/{{$invoiceDetail->product->Image}}" style="height:100px;">
                        </td>
                        <td
            ...
            <a href="{{route('admin.order.index')}}" style="float: right;"
                class="text-xs font-semibold leading-tight dark:text-white dark:opacity-80 text-slate-400">
                <button class=" bg-blue-500 hover:bg-blue-700 text-white font-bold py-4 px-6 rounded mb-4">
                    Back To All Order
                </button>
            </a>
        </div>
