...
<div class="row no-gutters">
	...
	<div class="home-category-banner bg-light-orange">
		...
		<img src="user/assets/images/items/2.jpg" class="img-bg">
	</div>
...
<a href="#" class="item"> 
	<div class="card-body">
		...
		<img class="img-sm float-right" src="user/assets/images/items/1.jpg"> 
...
<a href="#" class="item"> 
	<div class="card-body">
		...
		<img class="img-sm float-right" src="user/assets/images/items/2.jpg"> 
...
<a href="#" class="item"> 
	<div class="card-body">
		...
		<img class="img-sm float-right" src="user/assets/images/items/3.jpg"> 
...
<a href="#" class="item"> 
	<div class="card-body">
		...
		<img class="img-sm float-right" src="user/assets/images/items/4.jpg"> 
...
<a href="#" class="item"> 
	<div class="card-body">
		<h6 class="title">Home and kitchen electronic  stuff collection  </h6>
		<img class="img-sm float-right" src="user/assets/images/items/5.jpg"> 
...
<a href="#" class="item"> 
	<div class="card-body">
		<h6 class="title">Home and kitchen electronic  stuff collection  </h6>
		<img class="img-sm float-right" src="user/assets/images/items/6.jpg"> 
		<p class="text-muted"><i class="fa fa-map-marker-alt"></i> Guanjou, China</p>
	</div>
</a>
	</li>
...
<a href="#" class="item"> 
	<div class="card-body">
		...
		<img class="img-sm float-right" src="user/assets/images/items/7.jpg"> 
...
<div class="row no-gutters">
	...
	<div class="home-category-banner bg-light-orange">
		...
		<p>Consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. </p>
		<a href="#" class="btn btn-outline-primary rounded-pill">Source now</a>
		<img src="user/assets/images/items/14.jpg" class="img-bg">
	</div>
...
<a href="#" class="item"> 
	<div class="card-body">
		...
		<img class="img-sm float-right" src="user/assets/images/items/8.jpg"> 
		<p class="text-muted"><i class="fa fa-map-marker-alt"></i> Hong Kong, China</p>
	</div>
</a>
	</li>
...
<a href="#" class="item"> 
	<div class="card-body">
		<h6 class="title">Home and kitchen electronic  stuff collection  </h6>
		<img class="img-sm float-right" src="user/assets/images/items/9.jpg"> 
		<p class="text-muted"><i class="fa fa-map-marker-alt"></i> Tashkent, Uzb</p>
	</div>
</a>
	</li>
...
<a href="#" class="item"> 
	<div class="card-body">
		...
		<img class="img-sm float-right" src="user/assets/images/items/10.jpg"> 
		<p class="text-muted"><i class="fa fa-map-marker-alt"></i> Guanjou, China</p>
	</div>
</a>	
	</li>
...
<a href="#" class="item"> 
	<div class="card-body">
		<h6 class="title">Home and kitchen electronic  stuff collection  </h6>
		<img class="img-sm float-right" src="user/assets/images/items/11.jpg"> 
		<p class="text-muted"><i class="fa fa-map-marker-alt"></i> Guanjou, China</p>
	</div>
</a>
	</li>
...
<a href="#" class="item"> 
	<div class="card-body">
		<h6 class="title">Home and kitchen electronic  stuff collection  </h6>
		<img class="img-sm float-right" src="user/assets/images/items/12.jpg"> 
		<p class="text-muted"><i class="fa fa-map-marker-alt"></i> Guanjou, China</p>
	</div>
</a>
	</li>
...
<div class="row">
	<div class="col-md-8">
<div class="card-banner banner-quote overlay-gradient" style="background-image: url('user/assets/images/banners/banner9.jpg');">
...
<div class="row row-sm">
	<div class="col-xl-2 col-lg-3 col-md-4 col-6">
		<div href="#" class="card card-sm card-product-grid">
			<a href="#" class="img-wrap"> <img src="user/assets/images/items/1.jpg"> </a>
	...
	<div class="col-xl-2 col-lg-3 col-md-4 col-6">
		<div href="#" class="card card-sm card-product-grid">
			<a href="#" class="img-wrap"> <img src="user/assets/images/items/2.jpg"> </a>
			<figcaption class="info-wrap">
	...
	<div class="col-xl-2 col-lg-3 col-md-4 col-6">
		<div href="#" class="card card-sm card-product-grid">
			<a href="#" class="img-wrap"> <img src="user/assets/images/items/3.jpg"> </a>
			<figcaption class="info-wrap">
	...
	<div class="col-xl-2 col-lg-3 col-md-4 col-6">
		<div href="#" class="card card-sm card-product-grid">
			<a href="#" class="img-wrap"> <img src="user/assets/images/items/4.jpg"> </a>
			<figcaption class="info-wrap">
				<a href="#" class="title">Just another product name</a>
				<div class="price mt-1">$179.00</div> <!-- price-wrap.// -->
			</figcaption>
	...
	<div class="col-xl-2 col-lg-3 col-md-4 col-6">
		<div href="#" class="card card-sm card-product-grid">
			<a href="#" class="img-wrap"> <img src="user/assets/images/items/5.jpg"> </a>
			<figcaption class="info-wrap">
				<a href="#" class="title">Just another product name</a>
				<div class="price mt-1">$179.00</div> <!-- price-wrap.// -->
			</figcaption>
	...
	<div class="col-xl-2 col-lg-3 col-md-4 col-6">
		<div href="#" class="card card-sm card-product-grid">
			<a href="#" class="img-wrap"> <img src="user/assets/images/items/6.jpg"> </a>
			<figcaption class="info-wrap">
				<a href="#" class="title">Some item name here</a>
				<div class="price mt-1">$280.00</div> <!-- price-wrap.// -->
			</figcaption>
	...
	<div class="col-xl-2 col-lg-3 col-md-4 col-6">
		<div href="#" class="card card-sm card-product-grid">
			<a href="#" class="img-wrap"> <img src="user/assets/images/items/7.jpg"> </a>
			<figcaption class="info-wrap">
				<a href="#" class="title">Great product name here</a>
				<div class="price mt-1">$56.00</div> <!-- price-wrap.// -->
			</figcaption>
	...
	<div class="col-xl-2 col-lg-3 col-md-4 col-6">
		<div href="#" class="card card-sm card-product-grid">
			<a href="#" class="img-wrap"> <img src="user/assets/images/items/9.jpg"> </a>
			<figcaption class="info-wrap">
				<a href="#" class="title">Just another product name</a>
				<div class="price mt-1">$179.00</div> <!-- price-wrap.// -->
			</figcaption>
...
<div class="row">
	<div class="col-md-3 col-sm-6">
		<article class="card card-post">
		  <img src="user/assets/images/posts/1.jpg" class="card-img-top">
		  <div class="card-body">
	...
	<div class="col-md-3 col-sm-6">
		<article class="card card-post">
		  <img src="user/assets/images/posts/2.jpg" class="card-img-top">
		  <div class="card-body">
	...
	<div class="col-md-3 col-sm-6">
		<article class="card card-post">
		  <img src="user/assets/images/posts/3.jpg" class="card-img-top">
		  <div class="card-body">
	...
	<div class="col-md-3 col-sm-6">
		<article class="card card-post">
		  <img src="user/assets/images/posts/4.jpg" class="card-img-top">
		  <div class="card-body">
...
<ul class="row mt-4">
	<li class="col-md col-6"><a href="#" class="icontext"> <img class="icon-flag-sm" src="user/assets/images/icons/flags/CN.png"> <span>China</span> </a></li>
	<li class="col-md col-6"><a href="#" class="icontext"> <img class="icon-flag-sm" src="user/assets/images/icons/flags/DE.png"> <span>Germany</span> </a></li>
	<li class="col-md col-6"><a href="#" class="icontext"> <img class="icon-flag-sm" src="user/assets/images/icons/flags/AU.png"> <span>Australia</span> </a></li>
	<li class="col-md col-6"><a href="#" class="icontext"> <img class="icon-flag-sm" src="user/assets/images/icons/flags/RU.png"> <span>Russia</span> </a></li>
	<li class="col-md col-6"><a href="#" class="icontext"> <img class="icon-flag-sm" src="user/assets/images/icons/flags/IN.png"> <span>India</span> </a></li>
	<li class="col-md col-6"><a href="#" class="icontext"> <img class="icon-flag-sm" src="user/assets/images/icons/flags/GB.png"> <span>England</span> </a></li>
	<li class="col-md col-6"><a href="#" class="icontext"> <img class="icon-flag-sm" src="user/assets/images/icons/flags/TR.png"> <span>Turkey</span> </a></li>
	<li class="col-md col-6"><a href="#" class="icontext"> <img class="icon-flag-sm" src="user/assets/images/icons/flags/UZ.png"> <span>Uzbekistan</span> </a></li>
